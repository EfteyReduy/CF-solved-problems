...
main()
{
    ...
    for(int cas=1; cas<=t; cas++)
    {
        ...
        {
            int x=i;
            while(i<s.length() and (s[i]=='R' or s[i]=='O' or s[i]=='P' or s[i]=='A'))
            {
                i++;
            }
            if(x<i)
        ...
        {
            int x=i;
            while(i<s.length() and (s[i]=='Y' or s[i]=='O' or s[i]=='G' or s[i]=='A'))
            {
                i++;
            }
            if(x<i)
        ...
        {
            int x=i;
            while(i<s.length() and (s[i]=='B' or s[i]=='P' or s[i]=='G' or s[i]=='A'))
            {
                i++;
            }
            if(x<i)
