    ...
    while(t--)
    {
        ...
        for(int i=1; i<n; i++)
        {
            if(arr[i]<arr[i-1] and cou<1)
            {
                ...
                else if(arr[i]<arr[i-1] and cou>=1)
                {
                    pos=false;
                    break;
                }
        ...
        if(pos==true and arr[n-1]==0)
        {
            ...
            for(int i=n-2; i>=0; i--)
            {
                if(brr[i]<brr[i+1] and cou<1)
                {
                    ...
                    else if(brr[i]<brr[i+1] and cou>=1)
                    {
                        pos=false;
                        break;
                    }
